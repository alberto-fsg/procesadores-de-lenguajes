...
// --- Tipos ------------------------------------------------------------------
// Modified to return type string
...
// Returns scalar type as Symbol.Types enum
  static final public Symbol.Types tipoEscalar() throws ParseException {
    Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case tCHARACTER:
      t = jj_consume_token(tCHARACTER);
                           {if (true) return Symbol.Types.CHAR;}
      break;
    case tBOOLEAN:
      t = jj_consume_token(tBOOLEAN);
                           {if (true) return Symbol.Types.BOOL;}
      break;
    case tINTEGER:
      t = jj_consume_token(tINTEGER);
...
// Returns array type as Symbol.Types.ARRAY
  static final public Symbol.Types tipoArray() throws ParseException {
    Symbol.Types baseType;
    Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case tCHARACTER:
      t = jj_consume_token(tCHARACTER);
                           baseType = Symbol.Types.CHAR;
      break;
    case tBOOLEAN:
      t = jj_consume_token(tBOOLEAN);
                           baseType = Symbol.Types.BOOL;
      break;
    case tINTEGER:
      t = jj_consume_token(tINTEGER);
                           baseType = Symbol.Types.INT;
      break;
    default:
      jj_la1[2] = jj_gen;
      jj_consume_token(-1);
    ...
    jj_consume_token(tCLOSING_SQUARE_BRACKET);
      {if (true) return Symbol.Types.ARRAY;}
    throw new Error("Missing return statement in function");
  }
...
// --- Variables --------------------------------------------------------------
  ...
  static final public List<String> lista_ids() throws ParseException {
...
// --- Funciones y procedimientos ---------------------------------------------
  ...
  static final public void llamar_funcion_o_procedimiento() throws ParseException {
...
// --- Instrucciones ----------------------------------------------------------
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1c00,0x1c00,0x1c00,0x0,0x10000000,0xe300000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe300000,0x2000000,0xc300000,0x1c00,0x1c00,0x200,0x1c00,0x200,0x1c00,0xe300000,0x10000000,0x1813c00,0x1813c00,0x8000,0x400000,0x200,0x20000000,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x100000,0x0,0x0,0x1,0x0,0x101068,0xc00,0xc00,0x7e000,0x7e000,0x60,0x60,0x380,0x380,0x1060,0x1060,0x100008,0x0,0x100000,0x100000,0x100000,0x100000,0x100000,0x100000,0x100000,0x101068,0x0,0x100000,0x100000,0x0,0x0,0x0,0x0,0x0,};
   }
