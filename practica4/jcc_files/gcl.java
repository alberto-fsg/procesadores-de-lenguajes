...
public class gcl implements gclConstants {
   ...
   public static void main(String[] args) {
    ...
    private static CodeBlock setupProcedure(Token identificador, ArrayList<Symbol> parametros) {
        ...
        sProc.label = identificador.image;
...
// --- INICIO DE programa.jj ---
  static final public void Programa() throws ParseException {
    ...
    case tIDENTIFICADOR:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case tIDENTIFICADOR:
        cprocfun = declaracion_proc();
        break;
      case tINTEGER:
      case tCHARACTER:
      case tBOOLEAN:
        cprocfun = declaracion_func();
        break;
      default:
        jj_la1[0] = jj_gen;
        jj_consume_token(-1);
...
// --- INICIO DE funciones.jj ---
  static final public CodeBlock declaracion_proc() throws ParseException {
    ...
    CodeBlock headerPartCode;
    CodeBlock cuerpo = new CodeBlock();
    CodeBlock footerPartCode;
    CodeBlock finalProcedureCode = new CodeBlock();
    t = jj_consume_token(tIDENTIFICADOR);
    jj_consume_token(tOPENING_PARENTHESIS);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case tINTEGER:
    ...
    jj_consume_token(tEND);
        ...
        {if (true) return finalProcedureCode;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public CodeBlock llamar_funcion() throws ParseException {
    ...
    jj_consume_token(tSEMICOLON);
        ...
        // abrir stack frame
        c.addOSFInst(lPar.size(), st.level - fun.nivel, fun.label);
...
// --- INICIO DE especiales.jj ---
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x70000,0x70000,0x604f7e00,0x70000,0x70000,0x70000,0x0,0x0,0x6000,0x8c000000,0x0,0x0,0x8c006000,0x0,0x0,0x0,0x0,0x0,0x8c006000,0x0,0x0,0x70000,0x70000,0x70000,0x604f7e00,0x70000,0x70000,0x70000,0x604f7e00,0x8c006000,0x0,0x8000,0x0,0x8000,0x70000,0x7e00,0x480000,0x60000000,0x604f7e00,0x604f7e00,0x200000,0x604f7e00,0x10000000,0x8c006000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4000000,0x4000000,0x4000000,0x0,0x0,0x0,0x4,0x40,0x0,0x4000003,0x41800,0x41800,0x4000203,0xe000,0x1800,0x1f80000,0x30000,0x30000,0x4041a03,0xe000,0x1f80000,0x0,0x4000000,0x4000000,0x4000000,0x0,0x4000000,0x4000000,0x4000000,0x4041a03,0x4,0x0,0x8,0x0,0x4000000,0x0,0x0,0x0,0x4000000,0x4000000,0x0,0x4000000,0x0,0x4041a03,0x4,0x4000000,};
   }
